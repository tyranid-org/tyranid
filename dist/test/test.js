...
const field_1 = require("../src/core/field");
const type_1 = require("../src/core/type");
const unit_1 = require("../src/unit/unit");
const role_1 = require("./models/role"); // require to get extra link in prototype chain
const phantom_model_1 = require("./models/phantom.model");
const model_1 = require("./model");
require("./models/user");
const projection_1 = require("../src/core/projection");
const express_1 = require("../src/express");
const testEvent = require("./event.test");
const testFake = require("./fake.test");
const testQuery = require("./query.test");
const testDiff = require("./diff.test");
const testHistorical = require("./historical.test");
const testPopulation = require("./population.test");
const testUnit = require("./unit.test");
...
const { NamePath, $all, Log } = tyranid_1.default;
...
const oid1 = new ObjectId('55bb8ecff71d45b995ff8c83'), oid1_ = new ObjectId('55bb8ecff71d45b995ff8c83'), oid2 = new ObjectId('5567f2a8387fa974fc6f3a5a'), oid2_ = new ObjectId('5567f2a8387fa974fc6f3a5a'), oid3 = new ObjectId('aaa7f2a8387fa9abdc6f3ced'), oid3_ = new ObjectId('aaa7f2a8387fa9abdc6f3ced');
describe('tyranid', function () {
    var db = null;
    before(async () => {
        db = await mongodb.MongoClient.connect('mongodb://localhost:27017/tyranid_test');
        await tyranid_1.default.config({
            db: db,
    ...
    describe('ObjectId utilities', () => {
        it('should support isValidObjectId()', () => {
            ...
            for (const test of tests) {
                ...
                expect(tyranid_1.default.isValidObjectIdStr(value)).to.eql(expected);
            }
        });
    });
    describe('lodash-like methods', () => {
        it('should support isEqual with OIDs', () => {
            expect(tyranid_1.default.isEqual([oid1, oid2, oid3], [oid1_, oid2_, oid3_])).to.be.true;
        });
        it('should support indexOf with OIDs', () => {
            expect(tyranid_1.default.indexOf([oid1, oid2, oid3], oid2_)).to.eql(1);
            expect(tyranid_1.default.indexOf([oid1, oid2], oid3_)).to.eql(-1);
        });
        it('should support addToSet', () => {
            const a = [oid1, oid2];
            tyranid_1.default.addToSet(a, oid2_);
            expect(a.length).to.eql(2);
            tyranid_1.default.addToSet(a, oid3);
            expect(tyranid_1.default.isEqual(a, [oid1, oid2, oid3_])).to.be.true;
        });
        it('should support isSameId()', () => {
            ...
            for (const test of tests) {
                expect(tyranid_1.default.isSameId(test[0], test[1])).to.equal(test[2]);
            }
        });
        it('should support pullAll', () => {
            const a = [oid1, oid2, oid3];
            tyranid_1.default.pullAll(a, oid2_);
            expect(tyranid_1.default.isEqual(a, [oid1, oid3])).to.be.true;
            tyranid_1.default.pullAll(a, 3);
            expect(tyranid_1.default.isEqual(a, [oid1, oid3])).to.be.true;
        });
        it('should support isCompliant', () => {
            ...
            for (const testCase of tests) {
                expect(tyranid_1.default.isCompliant(testCase[0], testCase[1])).to.equal(testCase[2]);
                expect(tyranid_1.default.isCompliant(testCase[0])(testCase[1])).to.equal(testCase[2]);
            }
        });
    });
    describe('projection utilities', () => {
        it('should support projection lookups', () => {
            expect(projection_1.default.resolve({ default: { a: 1, b: 1 } }, 'default')).to.eql({ a: 1, b: 1 });
        });
        it('should merge projections', () => {
            expect(projection_1.default.resolve({ default: { a: 1, b: 1 } }, ['default', { c: 1 }])).to.eql({ a: 1, b: 1, c: 1 });
        });
    });
    describe('schema validation', function () {
        afterEach(() => {
            tyranid_1.default.forget('t00');
            tyranid_1.default.forget('t01');
            tyranid_1.default.forget('t02');
        });
        it('should error if no name is provided', function () {
            expect(function () {
                new tyranid_1.default.Collection({
                    id: 't00',
                    fields: {
                        _id: { is: 'mongoid' },
                    }
        ...
        it('should support re-usable bits of metadata', function () {
            expect(function () {
                ...
                new tyranid_1.default.Collection({
                    ...
                    fields: {
                        _id: { is: 'mongoid' },
                        one: tyranid_1.default.cloneDeep(Meta),
                        two: tyranid_1.default.cloneDeep(Meta)
                    }
                });
            }).to.not.throw();
        });
    ...
    describe('with model', function () {
        ...
        before(async function () {
            ...
            await tyranid_1.default.validate({
            ...
            Job = tyranid_1.default.byName.job;
            Organization = tyranid_1.default.byName.organization;
            Department = tyranid_1.default.byName.department;
            User = tyranid_1.default.byName.user;
            Task = tyranid_1.default.byName.task;
            Book = tyranid_1.default.byName.book;
            Location = tyranid_1.default.byName.location;
            await model_1.default();
        });
        describe('fields', () => {
            it('should support fields object', function () {
                expect(User.paths['name.first']).to.be.instanceof(field_1.default);
                expect(User.paths['roles._.role']).to.be.instanceof(field_1.default);
            });
            it('should support field.type', function () {
                expect(User.paths['name.first'].type).to.be.instanceof(type_1.default);
                expect(User.paths['roles._.role'].type).to.be.instanceof(type_1.default);
            });
            it('should support field.link', function () {
                expect(User.paths['roles._.role'].link).to.be.eql(tyranid_1.default.byName.role);
            });
        ...
        describe('maps', function () {
            it('should support "keys"', function () {
                expect(Department.paths['checkouts'].keys).to.be.instanceof(field_1.default);
                expect(Department.paths['checkouts'].keys.type.name).to.eql('uid');
            });
            it('should support "of"', function () {
                expect(Department.paths['checkouts'].of).to.be.instanceof(field_1.default);
        ...
        describe('schema methods', function () {
            it('should support fieldsBy()', function () {
                expect(User.fieldsBy(field => field.type.def.name === 'string').map(field => field.spath)).to.eql(['fullName', 'name.first', 'name.last', 'name.suffices', 'address.street', 'address.notes', 'oldName', 'ssn', 'favoriteColor', 'ageAppropriateSecret', 'siblings.name', 'title']);
            });
            it('should support static methods in ES6 class defs', async function () {
                const cursor = await role_1.default.search('Admin');
        ...
        describe('internal schemas', () => {
            it('should show internal collections as internal', () => {
                for (const c of tyranid_1.default.collections) {
        ...
        describe('finding', function () {
            ...
            it('should findOne() with direct ObjectId', function () {
                return role_1.default.findOne(AdministratorRoleId).then(function (doc) {
                    // Not instanceof check since Role is a class
                    expect(doc.$model).to.be.eql(tyranid_1.default.byName.role);
                });
            });
            it('should findOne() with direct ObjectId + projection', function () {
                return role_1.default.findOne(AdministratorRoleId, { _id: false }).then(function (doc) {
                    expect(doc.$model).to.be.eql(tyranid_1.default.byName.role);
        ...
        describe('strings', () => {
            it('should support support labelize', async () => {
                for (const test of [
                    ...
                    expect(tyranid_1.default.labelize(test[0])).to.eql(test[1]);
                }
            });
            it('should support support pluralize', async () => {
                for (const test of [
                    ...
                    expect(tyranid_1.default.pluralize(test[0])).to.eql(test[1]);
                }
            });
        });
        ...
        describe('fields', function () {
            it('model fields should be an instanceof Field', function () {
                expect(Job.def.fields.manager instanceof field_1.default).to.be.eql(true);
            });
        ...
        describe('documents', function () {
            it('should support $clone() on instances', async function () {
                const orig = await Book.byId(BookIsbn), clone = orig.$clone();
            ...
            it('should support $tyr on instances', function () {
                expect(Job.byLabel('Designer').$tyr).to.be.eql(tyranid_1.default);
            });
        ...
        describe('saving', function () {
            ...
            it('should save arrays', async () => {
                try {
                    await role_1.default.save([
                        new role_1.default({ name: 'A-1' }),
                        new role_1.default({ name: 'A-2' }),
                        new role_1.default({ name: 'A-3' })
                    ]);
                    const roles = await role_1.default.findAll({ query: { name: /^A-/ } });
                    expect(roles.length).to.eql(3);
                }
                finally {
                    await role_1.default.db.remove({ name: /^A-/ });
                }
            });
        });
        describe('values', function () {
            ...
            it('should support Tyranid.valuesBy()', function () {
                ...
                return tyranid_1.default.valuesBy(field => field.collection.name !== 'TyrInstance' && field.type.def.name === 'string').then(function (values) {
                    return values.sort();
        ...
        describe('static data', function () {
            ...
            it('it should support lookups by label in string data', () => {
                expect(unit_1.default.byLabel('dram').system.name).to.be.eql('english');
                expect(unit_1.default.byLabel('meter').system.name).to.be.eql('metric');
            });
        });
        describe('NamePath', function () {
            ...
            it('should support set', async () => {
                const u = await User.byId(3), np = u.$model.paths['name.first'].namePath;
                np.set(u, 'Molly');
            ...
            it('should support relative NamePaths', async () => {
                ...
                const nameNp = User.paths.name.namePath, firstNp = nameNp.parsePath('first');
        ...
        describe('denormalization', function () {
            var julia, juliaMatch = { 'name.first': 'Julia', 'name.last': 'Doe' };
            before(function () {
            ...
            it('simple denormalize pathing', function () {
                const np = new NamePath(User, 'organization_.name'), field = np.detail;
                expect(field.collection).to.be.eql(tyranid_1.default.byName.organization);
                expect(field.name).to.be.eql('name');
            });
            it('complex denormalize pathing', function () {
                const np = new NamePath(User, 'organization_.owner_.name.first'), field = np.detail;
                expect(field.collection).to.be.eql(tyranid_1.default.byName.user);
        ...
        describe('$update()', function () {
            ...
            it('should upsert', async () => {
                await role_1.default.db.remove({ name: 'foo' });
                let foo = new role_1.default({ name: 'foo' });
                await foo.$update();
                expect(foo._id).to.exist;
                foo = await role_1.default.findOne({ name: 'foo' });
                expect(foo).to.exist;
                await role_1.default.db.remove({ name: 'foo' });
            });
        });
        ...
        describe('uids', function () {
            ...
            it('should parse', function () {
                tyranid_1.default.parseUid('u001').should.eql({
                    collection: User,
                    id: 1
                });
            });
            it('should support byUid()', function () {
                return tyranid_1.default.byUid('u001').then(function (user) {
                    expect(user).to.be.an.instanceof(User);
                    expect(user._id).to.be.eql(1);
                });
            });
            it('should support byUids()', function () {
                return tyranid_1.default.byUids(['u001']).then(function (docs) {
                    expect(docs.length).to.eql(1);
                    expect(docs[0]).to.be.an.instanceof(User);
            ...
            it('should support byUids() from multiple collections', function () {
                return tyranid_1.default.byUids(['u001', 't041', 'u003']).then(function (docs) {
            ...
            it('should support byUids(), some of which are static', function () {
                return tyranid_1.default.byUids(['u001', 'j002', 'u003', 't041']).then(function (docs) {
        ...
        describe('phantom collections', () => {
            it('should let you query from phantom collections', async () => {
                const docs = await phantom_model_1.default.findAll({});
                expect(docs.length).to.equal(0);
            });
            it('should let you query from phantom collections', async () => {
                const doc = await phantom_model_1.default.findOne({});
                expect(doc).to.equal(null);
            });
        });
        describe('types', () => {
            it('should support Type.byName', () => {
                expect(type_1.default.byName.integer).to.exist;
            });
        });
        describe('logging', function () {
            const LogLevel = tyranid_1.default.byName.tyrLogLevel;
            ...
            it('should log simple strings', async function () {
                await tyranid_1.default.info('test');
            ...
            it('should log objects', async function () {
                await tyranid_1.default.info({ m: 'test', e: 'http' });
                const logs = await Log.findAll({});
                expect(logs.length).to.be.eql(1);
                expect(logs[0].m).to.be.eql('test');
                expect(logs[0].l).to.be.eql(LogLevel.INFO._id);
            ...
            it('should log errors', async function () {
                await tyranid_1.default.warn('test one', new Error('test'));
                const logs = await Log.findAll({});
                expect(logs.length).to.be.eql(1);
            ...
            it('should log errors, #2', async function () {
                await tyranid_1.default.info(new Error('test'));
                const logs = await Log.findAll({});
                expect(logs.length).to.be.eql(1);
                expect(logs[0].m).to.be.eql('test');
                expect(logs[0].st).to.match(/Error: test/);
            ...
            it('should throw on invalid parameters', function () {
                return tyranid_1.default.info(3, 'test')
            ...
            it('should throw on an invalid event', async function () {
                return tyranid_1.default.warn({ m: 'test', e: 'bad_event' })
                    .then(() => assert(false, 'no exception thrown'))
                    .catch(err => {
            ...
            it('should allow events to be added', async function () {
                tyranid_1.default.Log.addEvent('myEvent', 'My Event');
                await tyranid_1.default.info({ e: 'myEvent', m: 'a test' });
                const logs = await Log.findAll({});
                expect(logs.length).to.be.eql(1);
        ...
        describe('Tyr.cloneDeep()', function () {
            it('should handle ObjectIds', () => {
                ...
                expect(o).to.eql(tyranid_1.default.cloneDeep(o));
            });
        });
        describe('$copy() and $replace()', function () {
            ...
            it('should handle Tyr.$all', () => {
                const u = new User({ age: 5, name: { first: 'Amy', last: 'Tell' } });
                u.$copy({ age: 6 }, tyranid_1.default.$all);
                expect(u.name).to.be.undefined;
                expect(u.age).to.eql(6);
            });
        ...
        describe('isObject', function () {
            it('test if something is an object', () => {
                ...
                for (const test of tests) {
                    expect(tyranid_1.default.isObject(test[0])).to.be.eql(test[1]);
                }
            });
        });
        describe('isObjectId', function () {
            it('test if something is an object', () => {
                ...
                for (const test of tests) {
                    expect(tyranid_1.default.isObjectId(test[0])).to.be.eql(test[1]);
                }
            });
        });
        describe('parseBson', function () {
            it('pass through regular values but parse bson objects', () => {
                ...
                for (const test of tests) {
                    expect(tyranid_1.default.parseBson(test[0])).to.be.eql(test[1]);
                }
            });
        });
        describe('arraySort', function () {
            it('should take a mongo sort-style object', () => {
                ...
                tyranid_1.default.arraySort(myArray, { b: 1, c: -1 });
                expect(myArray).to.eql([{}, { b: 1 }, { b: 'alpha', c: 2 }, { b: 'alpha' }]);
            });
            it('should sort heterogenous values like mongo', () => {
                ...
                tyranid_1.default.arraySort(myArray, { a: 1 });
        ...
        describe('references', () => {
            ...
            it('should support exclude', async () => {
                const refs = await User.references({ ids: [1, 3], exclude: tyranid_1.default.byName.organization });
                expect(refs.length).to.eql(4);
            });
        ...
        describe('express', () => {
            ...
            before(async () => {
                const app = express(), user = await User.byId(1);
                app.use(bodyParser.json());
                tyranid_1.default.connect({
                    app,
                    auth: (req, res, next) => {
                ...
                await new Promise((resolve, reject) => {
                    ...
                    tyranid_1.default.connect({ http });
                });
            });
        ...
        describe('Client code generation', () => {
            it('Should include all collections', async () => {
                const code = express_1.generateClientLibrary();
