...
const units_1 = require("../src/unit/units");
const unitType_1 = require("../src/unit/unitType");
    ...
    describe('unit*.js', () => {
        ...
        describe('unit types', function () {
            it('should parse base and composite unit types', () => {
                expect(unitType_1.default.parse('l').name === 'length').to.be.true;
                expect(unitType_1.default.parse('l^2').name === 'area').to.be.true;
                expect(unitType_1.default.parse('l-2*lum').name === 'luminance').to.be.true;
                expect(() => unitType_1.default.parse('l-2*cure')).to.throw(/"cure"/);
            });
            it('should be shared and unique', () => {
                expect(unitType_1.default.parse('l') === unitType_1.default.parse('l')).to.be.true;
                expect(unitType_1.default.parse('l^2') === unitType_1.default.parse('l2')).to.be.true;
                expect(unitType_1.default.parse('l2m1/s2cur1') === unitType_1.default.parse('cur-1s-2m1l2')).to.be.true;
            });
        });
        describe('units', function () {
            it('should parse unit factors', () => {
                let u = unit_1.default.parse('km');
                expect(u.abbreviation).to.be.eql('km');
                expect(u.factor.symbol).to.be.eql('k');
                u = unit_1.default.parse('cm');
                expect(u.abbreviation).to.be.eql('cm');
                expect(u.factor.symbol).to.be.eql('c');
                u = unit_1.default.parse('kibibyte');
                expect(u.abbreviation).to.be.eql('KiB');
                expect(u.factor.symbol).to.be.eql('Ki');
            });
            it('should parse simple units', () => {
                let u = units_1.default.parse('cm');
                expect(u.cm).to.be.eql(1);
                u = units_1.default.parse('m');
                expect(u.m).to.be.eql(1);
                expect(() => units_1.default.parse('draculas')).to.throw(/"draculas"/);
            });
            it('should parse composite units', () => {
                let u = units_1.default.parse('m/s^2');
                expect(u.m).to.be.eql(1);
                expect(u.s).to.be.eql(-2);
                u = units_1.default.parse('m/s2');
                expect(u.m).to.be.eql(1);
                expect(u.s).to.be.eql(-2);
                u = units_1.default.parse('N*m');
                expect(u.N).to.be.eql(1);
                expect(u.m).to.be.eql(1);
                u = units_1.default.parse('s-2*m');
                expect(u.m).to.be.eql(1);
                expect(u.s).to.be.eql(-2);
                expect(() => units_1.default.parse('m/foo^2')).to.throw(/"foo"/);
            });
            it('should iterate', () => {
                const expected = { m: 1, s: -2 };
                _.each(units_1.default.parse('m/s^2'), (v, k) => {
                    expect(expected[k]).to.be.eql(v);
                });
            });
            it('should be shared and unique', () => {
                expect(unit_1.default.parse('s') === unit_1.default.parse('s')).to.be.true;
                expect(unit_1.default.parse('Mmol') === unit_1.default.parse('Mmol')).to.be.true;
                expect(unit_1.default.parse('km') === unit_1.default.parse('km')).to.be.true;
                expect(units_1.default.parse('m/s2') === units_1.default.parse('s-2*m')).to.be.true;
                expect(units_1.default.parse('N') === units_1.default.parse('N')).to.be.true;
            });
            it('should support "in" on numbers', () => {
                expect(User.paths.age.in.Yr).to.be.eql(1);
            });
            const U = tyranid_1.default.U;
            ...
            it('should support valid conversions', () => {
                ...
                for (const test of tests) {
                    const fromValue = test[0], fromUnits = U(test[1]), toValue = test[2], toUnits = U(test[3]);
            ...
            it('should throw on invalid conversions', () => {
                ...
                for (const test of tests) {
                    const fromValue = test[0], fromUnits = U(test[1]), toUnits = U(test[2]);
            ...
            it('should support planck units', () => {
                const c = 299792458, EP = 1.0, mP = EP, // EP == mP
                m = U `mP`.convert(mP, U `kg`), E = m * c * c;
