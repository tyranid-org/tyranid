...
function add() {
    describe('query.js', () => {
        const { intersection, matches, merge } = tyranid_1.default.query, i1 = '111111111111111111111111', i2 = '222222222222222222222222', i3 = '333333333333333333333333', i4 = '444444444444444444444444';
        describe('merge()', () => {
            ...
            it('should work with $and', () => {
                testl({ $and: [{ blog: 1 }, { org: 1 }] }, { $and: [{ foo: 1 }, { bar: 2 }] }, { $and: [{ blog: 1 }, { org: 1 }, { foo: 1 }, { bar: 2 }] });
            });
            it('should work with $or', () => {
                testl({ $or: [{ blog: 1 }, { org: 1 }] }, { $or: [{ foo: 1 }, { bar: 2 }] }, { $and: [{ $or: [{ blog: 1 }, { org: 1 }] }, { $or: [{ foo: 1 }, { bar: 2 }] }] });
            });
            it('should work with $or and $ands together', () => {
                testl({ $or: [{ blog: 1 }, { org: 1 }], $and: [{ a1: 1 }, { b1: 1 }] }, { $or: [{ foo: 1 }, { bar: 2 }], $and: [{ c1: 1 }] }, { $and: [
                        { $or: [{ blog: 1 }, { org: 1 }] },
                        { $or: [{ foo: 1 }, { bar: 2 }] },
                        { a1: 1 },
                        { b1: 1 },
            ...
            it('should work with nested $and/$or', () => {
                test({ $and: [{ $or: [{ blogId: { $in: [O('56fc2aacbb4c31a277f9a454')] } }] }, { $and: [{ _id: { $nin: [O('56fc2aacbb4c31a277f9a45b')] } }] }] }, {}, { $and: [{ $or: [{ blogId: { $in: [O('56fc2aacbb4c31a277f9a454')] } }] }, { $and: [{ _id: { $nin: [O('56fc2aacbb4c31a277f9a45b')] } }] }] });
            });
        ...
        describe('intersection()', () => {
            ...
            it('should support logical operators', () => {
                test({ $or: [{ blog: 1 }, { org: 1 }] }, { $and: [{ a1: 1 }, { b1: 1 }] }, { $or: [{ blog: 1 }, { org: 1 }],
                    $and: [{ a1: 1 }, { b1: 1 }] });
            });
        });
        describe('matches()', () => {
