...
let Organization, Department, User, Phantom, Task, Book, TyrSchema, TyrSchemaType;
...
async function initModel() {
    ...
    TyrSchema = tyranid_1.default.byName.tyrSchema;
    TyrSchemaType = tyranid_1.default.byName.tyrSchemaType;
    Phantom = tyranid_1.default.byName.phantom;
    ...
    await role_1.default.db.remove({});
    await role_1.default.db.insert([
    ...
    await tyranid_1.default.Log.remove({});
}
